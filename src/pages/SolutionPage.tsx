...
const SolutionPage = () => {
  ...
  const solution = getSolutionBySlug(language, slug || '');
  ...
  const sectionLabels = {
    pt: { challenges: 'Principais desafios resolvidos', approach: 'Abordagem Stratumtec', results: 'Resultados esperados', backTo: '← Voltar às Soluções' },
    en: { challenges: 'Key challenges solved', approach: 'Stratumtec approach', results: 'Expected results', backTo: '← Back to Solutions' },
    es: { challenges: 'Principales desafíos resueltos', approach: 'Enfoque Stratumtec', results: 'Resultados esperados', backTo: '← Volver a Soluciones' },
  };
            ...
            <div className="grid lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
              ...
              <div className="bg-card p-8 rounded-xl border border-border">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-lg font-heading font-bold text-secondary">{labels.challenges}</h2>
                </div>
              ...
              <div className="bg-card p-8 rounded-xl border border-border">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-lg font-heading font-bold text-secondary">{labels.approach}</h2>
                </div>
                <ul className="space-y-3">
              ...
              <div className="bg-card p-8 rounded-xl border border-border">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-lg font-heading font-bold text-secondary">{labels.results}</h2>
                </div>
                <ul className="space-y-3">
