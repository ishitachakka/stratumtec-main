      ...
      <section className="pt-32 pb-16 bg-stratumtec-navy/95 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-6 text-center relative z-10 flex items-end min-h-[200px]">
          <div className="max-w-4xl mx-auto">
            ...
            <CalendarPopup trigger={<Button size="lg" className="bg-stratumtec-orange text-white hover:bg-stratumtec-orange/90 hover:shadow-xl hover:scale-105 transition-all duration-300 px-8 py-4"><Play className="mr-2 h-5 w-5" />{t.demoButton}</Button>} triggerAsChild />
          </div>
        </div>
      </section>
                        ...
                        <CardHeader className="pb-4">
                          <div className={`flex items-center gap-4 ${isLeft ? 'flex-row-reverse' : 'flex-row'}`}>
                            ...
                            <div className={isLeft ? 'text-right' : 'text-left'}>
                              <CardTitle className="text-2xl font-heading text-stratumtec-navy mb-1">{solution.title}</CardTitle>
                              <p className="text-sm font-medium text-stratumtec-orange">{solution.subtitle}</p>
                            </div>
                          </div>
                        </CardHeader>
                        <CardContent>
                          <CardDescription className="text-lg text-stratumtec-text mb-6 leading-relaxed">{solution.description}</CardDescription>
                          <div className="bg-stratumtec-orange/10 rounded-xl p-4 mb-6 border border-stratumtec-orange/20">
                            <p className="text-sm font-semibold text-stratumtec-navy flex items-center gap-2"><CheckCircle className="h-4 w-4 text-stratumtec-orange" />{solution.benefits}</p>
                          </div>
                          ...
                          <div className="flex gap-3">
                            <Button size="sm" className="bg-stratumtec-orange text-white hover:bg-stratumtec-orange/90 hover:shadow-lg">{t.learnMore}<ArrowRight className="ml-2 h-4 w-4" /></Button>
                            <CalendarPopup trigger={<Button variant="outline" size="sm" className="border-stratumtec-orange text-stratumtec-orange hover:bg-stratumtec-orange hover:text-white">{t.freeDemo}</Button>} triggerAsChild />
                          </div>
                        </CardContent>
                      </Card>
                    </div>
        ...
        <div className="container mx-auto px-4 lg:px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <CalendarPopup trigger={<Button size="lg" className="bg-stratumtec-orange text-white hover:bg-stratumtec-orange/90 hover:scale-105 transition-all duration-300 px-8 py-4 shadow-xl"><Users className="mr-2 h-5 w-5" />{t.talkExpert}</Button>} triggerAsChild />
              <CalendarPopup trigger={<Button variant="outline" size="lg" className="border-white text-stratumtec-cyan hover:bg-stratumtec-orange hover:border-stratumtec-orange hover:text-white hover:scale-105 transition-all duration-300 px-8 py-4">{t.requestDemo}</Button>} triggerAsChild />
            </div>
          </div>
        </div>
      </section>
